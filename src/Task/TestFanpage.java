...
public class TestFanpage {
  ...
  public void GetTitles() {
		driver.get(baseUrl);
		List<WebElement> TitlesList = driver.findElements(By.xpath("//div[@class='excellent_list pc_display']//div[@class='excel_tit']"));
  ...
  public void ActionExe() throws Exception {
	   ...
	   builder.moveToElement(driver.findElement(By.xpath("//*[@id='sh_sh']"))).perform();
  ...
  public void Frametry()throws Exception{
	  driver.get(baseUrl);
	  WebElement webElement = driver.switchTo().frame(0).findElement(By.className("ad_notice"));
  ...
  public void WindowHandles()throws Exception{
      ...
      for(String handler:handles){
    	  driver.switchTo().window(handler); //³¢ÊÔÇÐ»»
    	  String title = driver.getTitle();
    	  if (title.contains("°ïÖú")){
    	  a = 10;
    	  break; //Ìø³öÑ­»·2
    	  }  
	  }
